...
$recipient = "DFeatherstoneConstructionLLC@twcny.rr.com";
$subject = "Contact Form";
$mailheader = "From: $email \r\n";
mail($recipient, $subject, $formcontent, $mailheader) or die("Error!");
echo "Thank you for requesting an estimate. We will get back to you as seen as we can!" . " -" . "<a href='index.html' style='text-decoration:none;color:#ff0099;'>Return Home</a>
				";
?>
			</div>
		</div>
